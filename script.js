document.addEventListener('DOMContentLoaded', function() {
  ...
  const rsvpForm = document.getElementById('rsvp-form'); // <--- Вот это добавление решает твою ошибку!
  ...
  const mainScreen = document.get{document].getElementById('main-screen');
